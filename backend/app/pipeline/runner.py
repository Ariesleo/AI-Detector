...
def analyze(image_bytes: bytes, mime: str = "image/jpeg", use_claude: bool = True) -> AnalysisReport:
    """use_claude=False disables the paid L4/L5 calls (daily budget kill-switch)."""
    ...
    with ThreadPoolExecutor(max_workers=4) as pool:
        ...
        f4 = pool.submit(l4_vision.run, image_bytes, use_claude)
    ...
    verdict, confidence, summary, engine = l5_verdict.aggregate(evidence, layers, use_claude=use_claude)
